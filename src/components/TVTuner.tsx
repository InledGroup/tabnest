...
export const TVTuner: React.FC<TVTunerProps> = ({ channels, loading, onClose, lang }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/90 backdrop-blur-2xl flex flex-col animate-in fade-in duration-300">
      ...
      {selectedChannel && (
        <div className="fixed inset-0 z-[70] bg-black flex flex-col animate-in zoom-in duration-300">
          {/* Player Header */}
          ...
          <div className="flex-grow flex items-center justify-center relative overflow-hidden bg-black">
            ...
            {showSchedule && selectedChannel.epg && selectedChannel.epg.length > 0 && (
              <div className="absolute top-24 right-6 bottom-6 w-80 bg-slate-950/80 backdrop-blur-xl rounded-3xl border border-white/10 flex flex-col shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] animate-in slide-in-from-right duration-300">
